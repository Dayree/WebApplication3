...
namespace WebApplication3.Controllers
{
    public class UrunsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UrunAdi,Renk,Model,Fiyat")] Urun urun)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UrunAdi,Renk,Model,Fiyat")] Urun urun)
        {
            if (id != urun.Id)
            {
                return NotFound();
